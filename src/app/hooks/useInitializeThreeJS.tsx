...
export const useInititializeThreeJS = () => {
  ...
  return { scene: sceneRef.current, camera: cameraRef.current, world: worldRef.current, renderer: rendererRef.current, addLuminescentSnow, stopSnow, animationFrameID: animationFrameIDRef.current };
};
